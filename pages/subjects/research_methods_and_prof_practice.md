  ...
  <div class="swiper-wrapper">
    <div class="swiper-slide">
        ...
        <h2 id="reflective1">Reflective Activity 1: Ethics in Computing in the age of Generative AI</h2>
            <p>The first assignment was a reflective piece based on Corrêa et al. (2023) and Deckard (2023), addressing the legal, social, ethical, and professional issues of generative AI in the computing industry.<br><br>

            <strong>Evaluating AI Ethics and Governance in the Generative AI Era</strong><br><br>

            The rise of generative AI, exemplified by ChatGPT, Midjourney, and AlphaCode, has amplified global concerns around ethical, legal, and professional responsibilities. Corrêa et al. (2023), reviewing over 200 AI ethics guidelines, and Deckard (2023) highlight that while core principles like transparency, accountability, and fairness are widely endorsed, enforcement and cultural interpretation vary.<br><br>

            Five key principles, beneficence, non-maleficence, autonomy, justice, and explicability, are echoed across frameworks such as the EU’s High-Level Expert Group on AI (European Commission, 2024), Japan’s Social Principles (Cabinet Secretariat, 2019), and Brazil’s PL 2338/2023 (UNESCO, N.D.). Yet, the EU’s push for binding laws contrasts with other regions' reliance on voluntary codes, creating regulatory gaps and ethical inconsistencies, particularly when AI systems cross borders.<br><br>

            Professionals must balance innovation with risks like misinformation and job loss. Deckard (2023) stresses that ethics should be ingrained in professional culture. While BCS (2024), ACM (2018), and IEEE (2023) advocate harm reduction and inclusivity, lasting change depends on embedding ethics into education, hiring, and practice, despite market pressures.<br><br>
            ...
            <ul>
                <li>
                    <strong>Mandatory Impact Assessments:</strong> organizations deploying generative AI should conduct assessments covering risks like bias, misuse, and labor impact, similar to GDPR requirements.<br><br>
                </li>
                <li>
                    <strong>AI ethics by design:</strong> ethics must be integrated early, using fairness metrics, interpretability tools, and human oversight from the start.<br><br>
                </li>
                <li>
                    <strong>International harmonisation with cultural sensitivity:</strong> shared AI principles should allow cultural adaptation, such as autonomy varying across societies, requiring flexible yet aligned frameworks.<br><br>
                </li>
                <li>
                    <strong>Legal backstops for high-risk AI:</strong> harmful applications like deepfakes or surveillance must be strictly regulated, with liability shared by developers and deployers.<br><br>
                </li>
                <li>
                    <strong>Public AI literacy and feedback channels:</strong> public understanding is vital. Education and feedback systems should target especially vulnerable communities.<br><br>
                </li>
            </ul>
        ...
        <h2 id="eportfolio1">e-Portfolio Activity: Literature Review and Research Proposal Outlines</h2>
            <p>The first e-portfolio activity involved outlining literature review and capstone project ideas. My review, titled "Uplifting Voices," explores how AI can support the preservation of minority languages in digital form, with feedback planned for unit 4.<br><br>

            My capstone project, "Simulating Risk-Based Decision-Making and Dopaminergic Dysfunctions," aims to model dopamine-related behaviours in gambling scenarios using hierarchical reinforcement learning. The outline will be submitted in unit 8.</p><br><br>


        <h2 id="colab-1">Collaborative Learning Discussion 1</h2>
            <p>The first collaborative discussion introduced students to ethics and conduct in AI, requiring analysis of a case study from the ACM. My initial post, titled "Death Machines – The Ethics of Autonomous Weapons", was as follows:<br><br>
        ...
        <h2 id="eportfolio2">e-Portfolio Activity: Research Proposal Review</h2>
            <p>The second e-portfolio activity involved explaining which research methods would support our final project. For my proposal, "cognitive task analysis" is the most suitable, as it examines mental processes like decision-making and judgment (Sage, 2021). I plan to use psychometric techniques for data collection, applying mathematical methods to measure psychological constructs. Key skills for the project include reinforcement learning, psychology, cognitive modelling, and computational neuroscience.</p><br><br>
        ...
        <h2 id="colab-2">Collaborative Learning Discussion 2</h2>
            <p>The second collaborative discussion centred on Abi, a researcher facing a potential ethical conflict driven by his employer’s corporate interests. My initial post, titled "Initial Post," was as follows:<br><br>
        ...
        <h2 id="final-reflection">Reflective Piece</h2>
            ...
            McKinsey. (2023) <i>The economic potential of generative AI: The next productivity frontier</i>. Available at: https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier (Accessed: 18 July 2025).

            Rolfe, G., Freshwater, D. and Jasper, M. (2001) <i>Critical Reflection for Nursing and the Helping Professionals: A User's Guide</i>. Basingstoke: Palgrave Macmillan.</p>
    </div>
  </div>
</div>
</main>
